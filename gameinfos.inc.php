...
$gameinfos = [
    ...
    'game_name' => "Hey! That's my fish",

    // Game publisher (use empty string if there is no publisher)
    'publisher' => 'Next Move Games',

    // Url of game publisher website
    'publisher_website' => 'https://www.nextmove-games.com/en/',
    ...
    'tie_breaker_description' => totranslate("The most ice floe Tiles collected."),
    ...
    'player_colors' => ["ff6e48", "fec307", "9d56cc", "32a094"],
